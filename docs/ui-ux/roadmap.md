...
- P0-04: da co state primitive chung; Admin Users, Doctors, AI Configs,
  Subscription Plans va Facilities da co loading/error/retry/empty matrix va
  keyboard test; can tiep tuc migrate cac data surface con lai.
...
| P1-09 | Records da co backend phan tich xet nghiem | Hoan thien upload, lich su, chi tiet va trang thai xu ly theo contract | `/records` | Chi hien thi du lieu API cua tai khoan; payload lay profile va ngay xet nghiem | Da co contract |
