...
export default function FacilityExplorerControls({ search, onSearch, suggestions, onSuggestion,
  ...
  if (filtersOpen) return <form className="explorer-filters" onSubmit={(event) => {
    ...
    {radiusKm === "auto" && <p className="explorer-muted">Hệ thống tự mở rộng phạm vi từ 1 đến tối đa 50 km và dừng ngay khi có kết quả. Ban đầu hiển thị 5 cơ sở được đánh giá nổi bật; bạn có thể xem thêm trong cùng phạm vi.</p>}
