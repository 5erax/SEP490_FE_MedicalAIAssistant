      ...
      <section className="main-grid">
        <div className="stack">
          <article className="feature-card">
            ...
            <textarea placeholder="Mô tả triệu chứng bằng tiếng Việt..." />
            <button className="primary-btn full" type="button" onClick={() => navigate("/symptom")}>Phân tích ngay →</button>
          </article>
...
@media(max-width:767px){.dash-page{padding:24px 14px 48px}.dash-header{flex-direction:column}.stats-row{display:flex;overflow-x:auto;padding-bottom:8px}.stats-row article{min-width:220px}.main-grid{grid-template-columns:1fr}.reminder-item{grid-template-columns:auto 1fr}.mini-chat{grid-template-columns:1fr}}
`;
