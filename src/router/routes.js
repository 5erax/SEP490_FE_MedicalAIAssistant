...
const ADMIN_SECTION_TITLES = {
  ...
  "consultation-questions": "Quản lý câu hỏi tư vấn",
  "consultation-checklists": "Quản lý checklist chuẩn bị",
...
const ADMIN_SECTION_NAVIGATION = {
  ...
  payments: { label: "Lịch sử thanh toán", icon: "subscription" },
  ...
  "consultation-questions": { label: "Câu hỏi tư vấn", icon: "consultation-question" },
  "consultation-checklists": { label: "Checklist chuẩn bị", icon: "consultation-checklist" },
...
const BASE_ROUTES = [
  ...
  },
  {
    ...
    access: "auth",
    shell: "patient",
    navigation: { shell: "patient", label: "Phân tích triệu chứng", hint: "Xem lượt và bắt đầu", icon: "symptom", order: 30 },
  ...
  },
  {
    ...
    path: "/my-medications",
    title: "Thuốc & lịch nhắc | MediMate AI",
    access: "auth",
    shell: "patient",
  ...
  {
    id: "doctor.recovery-plan-queue",
    path: "/app/staff/recovery-plans/queue",
    title: "Hàng đợi Kế hoạch phục hồi | MediMate AI",
    access: "role",
    roles: ["doctor"],
    shell: "staff",
  },
  {
    id: "doctor.recovery-plan-mine",
    path: "/app/staff/recovery-plans/mine",
    title: "Yêu cầu của tôi | MediMate AI",
    access: "role",
    roles: ["doctor"],
    shell: "staff",
  },
  {
    id: "doctor.recovery-plan-request-detail",
    path: "/app/staff/recovery-plan-requests/:requestId",
    title: "Chi tiết yêu cầu | MediMate AI",
    access: "role",
    roles: ["doctor"],
    shell: "staff",
  },
  {
    id: "doctor.recovery-plan-templates",
    path: "/app/staff/recovery-plan-templates",
    title: "Kế hoạch mẫu | MediMate AI",
    access: "role",
    roles: ["doctor"],
    shell: "staff",
  },
  {
    id: "doctor.recovery-plan-template-editor",
    path: "/app/staff/recovery-plan-templates/:templateId",
    title: "Soạn kế hoạch mẫu | MediMate AI",
    access: "role",
    roles: ["doctor"],
    shell: "staff",
  },
